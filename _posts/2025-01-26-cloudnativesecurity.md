...
Microsoft Azure provides a couple of built-in security mechanisms to secure and authenticate towards Container-App and App-Service API resources that can be provisioned during deployment. To secure and access such API-resources using these built-in mechanisms you need to do a couple of things.
